...
public class ApiErrorHandler {
  ...
  ResponseEntity<?> negocio(ApiException e) {
    return erro(e.status, e.getMessage());
  }
  ...
  ResponseEntity<?> formato(Exception e) {
    return erro(
        HttpStatus.BAD_REQUEST,
        "JSON, identificador, status ou data/hora inválidos. Use ISO 8601 com fuso horário.");
  }

  @ExceptionHandler(NoResourceFoundException.class)
  ResponseEntity<?> ausente(Exception e) {
  ...
  ResponseEntity<?> inesperado(Exception e) {
